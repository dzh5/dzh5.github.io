(function () {
    ...
    Lampa.Template.add('tracks_css', "\n    <style>\n    .tracks-loading{margin-top:1em;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:start;-webkit-align-items:flex-start;-moz-box-align:start;-ms-flex-align:start;align-items:flex-start}.tracks-loading:before{content:'';display:inline-block;width:1.3em;height:1.3em;background:url('./img/loader.svg') no-repeat 50% 50%;-webkit-background-size:contain;-moz-background-size:contain;-o-background-size:contain;background-size:contain;margin-right:.4em}.tracks-loading>span{font-size:1.1em;line-height:1.1}.tracks-metainfo{margin-top:2em;display:flex;justify-content:space-between;flex-wrap:wrap;}.tracks-metainfo__line+.tracks-metainfo__line{width:70%;float:right;}.tracks-metainfo__line:first-child{position: absolute;top:5.4em;left:0.3em;}.tracks-metainfo__line:first-child .tracks-metainfo__label{display:none;}.tracks-metainfo__line:first-child .tracks-metainfo__info{padding:0;}.tracks-metainfo__line:first-child .tracks-metainfo__info>div{background:none;}.tracks-metainfo__line:first-child .tracks-metainfo__info>div>div{background: #00000038;padding: 0.1em 0.5em 0.5em;border-radius:0.3em;margin-right:0.3em;text-shadow:2px 2px 0px #000;border:1px solid #00000059;box-shadow:inset 0px -16px 10px 0px #0000008f;font-size:0.6em;}.tracks-metainfo__line+.tracks-metainfo__line+.tracks-metainfo__line{width:28%;float:left;}.tracks-metainfo__label{opacity:.5;font-weight:600}.tracks-metainfo__info{padding-top:1em;line-height:1.2}.tracks-metainfo__info>div{background-color:rgba(0,0,0,0.22);display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-border-radius:.3em;-moz-border-radius:.3em;border-radius:.3em;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap}.tracks-metainfo__info>div.focus{background-color:rgba(255,255,255,0.06)}.tracks-metainfo__info>div>div{padding:0.7em;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0}.tracks-metainfo__info>div+div{margin-top:1em}.tracks-metainfo__column--video,.tracks-metainfo__column--name{margin-right:auto;max-width:25em;}.tracks-metainfo__column--num{padding-right:0}.tracks-metainfo__column--rate{min-width:7em;text-align:right}.tracks-metainfo__column--channels{min-width:3em;text-align:right}@media screen and (max-width: 400px){.tracks-metainfo__line:first-child .tracks-metainfo__label{display:block;}.tracks-metainfo__line:first-child {position:initial;width:100%;}}\n    </style>\n"); 
