...
.tracks-metainfo__line+.tracks-metainfo__line
{
	float: right;
	width: 70%;
}
.tracks-metainfo__line:first-child
{
	left: 0.3em;
	position: absolute;
	top: 5.4em;
}
.tracks-metainfo__line:first-child .tracks-metainfo__label
{
	display: none;
}
.tracks-metainfo__line:first-child .tracks-metainfo__info
{
	padding: 0;
}
.tracks-metainfo__line:first-child .tracks-metainfo__info>div
{
	background: none;
}
.tracks-metainfo__line:first-child .tracks-metainfo__info>div>div
{
	background: #00000038;
	border: 1px solid #00000059;
	border-radius: 0.3em;
	box-shadow: inset 0px -16px 10px 0px #0000008f;
	font-size: 0.6em;
	margin-right: 0.3em;
	padding: 0.1em 0.5em 0.5em;
	text-shadow: 2px 2px 0px #000;
}
.tracks-metainfo__line+.tracks-metainfo__line+.tracks-metainfo__line
{
	float: left;
	width: 28%;
}
.tracks-metainfo__label
{
	font-weight: 600;
	opacity: .5;
}
.tracks-metainfo__info
{
	line-height: 1.2;
	padding-top: 1em;
}
.tracks-metainfo__info>div
{
...
.tracks-metainfo__info>div.focus
{
	background-color: rgba(255,255,255,0.06);
}
.tracks-metainfo__info>div>div
{
	flex-shrink: 0;
	ms-flex-negative: 0;
	padding: 0.7em;
...
.tracks-metainfo__column--video,.tracks-metainfo__column--name
{
	margin-right: auto;
	max-width: 25em;
}
.tracks-metainfo__column--num
{
	padding-right: 0;
}
.tracks-metainfo__column--rate
{
	min-width: 7em;
	text-align: right;
}
.tracks-metainfo__column--channels
{
	min-width: 3em;
	text-align: right;
}
