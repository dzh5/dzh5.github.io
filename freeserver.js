...
Lampa.SettingsApi.addParam({
    ...
    onChange: function (value) {
     if (value == 'no_parser') Lampa.Storage.set('torrserver_url', '')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'lg');
     if (value == 'jac_lampa32_ru') Lampa.Storage.set('torrserver_url', 'jac.lampa32.ru')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'lg');
     if (value == 'j_yourok_ru') Lampa.Storage.set('torrserver_url', 'j.yourok.ru')&Lampa.Storage.set('jackett_key', '1')&Lampa.Storage.set('jackett_interview', 'healthy')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'df_lg');
     if (value == 'jacred_xyz') Lampa.Storage.set('torrserver_url', 'jacred.xyz')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview', 'all')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'df_lg');
     if (value == 'spawn_pp_ua') Lampa.Storage.set('torrserver_url', 'spawn.pp.ua:59117')&Lampa.Storage.set('jackett_key', '2')&Lampa.Storage.set('jackett_interview', 'healthy')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'df');
     if (value == 'jacred_ru') Lampa.Storage.set('torrserver_url', 'jacred.ru')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'lg');
     if (value == 'unknown') Lampa.Storage.set('torrserver_url', 'http://188.119.113.252:9117')&Lampa.Storage.set('jackett_key', '1')&Lampa.Storage.set('jackett_interview', 'healthy')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'df');
     ...
     onRender: function (item) {
       setTimeout(function() {
        ...
        if(Lampa.Storage.field('torrserver_use_link')) item.show()&$('.settings-param__name', item).css('color','f3d900')&$('div[data-name="torrserver122"]').insertAfter('div[data-name="torrserver_use_link"]');
        else item.hide();
          }, 0);
        }
   });
