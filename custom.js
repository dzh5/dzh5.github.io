(function () {
	...
	Lampa.Listener.follow('app', function(e) {
		if(e.type == 'ready') {
			...
			$("#app > div.wrap.layer--height.layer--width > div.wrap__content.layer--height.layer--width > div > div > div.activity.layer--width.activity--active > div.activity__body > div > div > div > div > div.full-start-new > div.full-start-new__body > div.full-start-new__right > div.full-start-new__buttons > div.full-start__button.selector.button--play").remove();
