...
Lampa.SettingsApi.addParam({
    ...
    onChange: function (value) {
     ...
     if (value == 'localhost') Lampa.Storage.set('torrserver_url', '192.168.1.43:8090')&Lampa.Storage.set('torrserver_url_two', 'localhost:8090');
     if (value == 'public12') Lampa.Storage.set('torrserver_url', 'http://torr.myftp.biz:8090/')&Lampa.Storage.set('torrserver_url_two', 'http://trs.my.to:8595/');
     if (value == 'public34') Lampa.Storage.set('torrserver_url', 'http://tr.my.to:8595/')&Lampa.Storage.set('torrserver_url_two', 'http://176.124.198.209:8595/');
     if (value == 'public56') Lampa.Storage.set('torrserver_url', 'http://trs.ix.tc:8595/')&Lampa.Storage.set('torrserver_url_two', '');
