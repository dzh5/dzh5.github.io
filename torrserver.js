...
Lampa.SettingsApi.addParam({
	...
	//Lampa.Storage.set('torrserver_password','ts');
     ...
     onRender: function (item) {
       setTimeout(function() {
        $('div[data-name="torrserver_url"] div.settings-param__name, div[data-name="torrserver_url"] div.settings-param__descr').remove();
...
Lampa.SettingsApi.addParam({
	...
	//Lampa.Storage.set('torrserver_password','ts');
     ...
     onRender: function (item) {
       setTimeout(function() {
        $('div[data-name="torrserver_url_two"] div.settings-param__name, div[data-name="torrserver_url_two"] div.settings-param__descr').remove();
