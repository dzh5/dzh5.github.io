! function() {
    ...
    function r() {
        var t = $('<li class="menu__item selector" data-action="kion"><div class="menu__ico">' + e + '</div><div class="menu__text">Netflix</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function l() {
        var t = $('<li class="menu__item selector" data-action="rus"><div class="menu__ico">' + e + '</div><div class="menu__text">Дорамы</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function d() {
        ...
        })), $(".menu .menu__list").eq(0).append(e), setTimeout((function() {
    ...
    window.plugin_podbor_ready || function() {
        function e() {
            window.plugin_podbor_ready || ("1" == Lampa.Storage.get("porborki_kach") && t(), "1" == Lampa.Storage.get("porborki_rus") && c(), "1" == Lampa.Storage.get("porborki_okko") && a(), "1" == Lampa.Storage.get("porborki_ivi") && o(), "1" == Lampa.Storage.get("porborki_wink") && n(), "1" == Lampa.Storage.get("porborki_kion") && i(), "1" == Lampa.Storage.get("porborki_netflix") && r(), "1" == Lampa.Storage.get("porborki_kr") && l(), "1" == Lampa.Storage.get("porborki_kp") && p(), "1" == Lampa.Storage.get("porborki_mult12") && s(), "1" == Lampa.Storage.get("porborki_mult13") && m(), "1" != Lampa.Storage.get("porborki_mult14") && "0" == Lampa.Storage.get("porborki_mult14") || d(), "1" == Lampa.Storage.get("porborki_mult15") && u()), window.plugin_podbor_ready = !0, Lampa.SettingsApi.addComponent({
                component: "porborki",
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="mult"]').length ? d() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="mult12"]').length ? s() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="mult15"]').length ? u() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="mult13"]').length ? m() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="rus"]').length ? c() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="hd"]').length ? t() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="okko"]').length ? a() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="kp"]').length ? p() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="ivi"]').length ? o() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="wink"]').length ? n() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="kion"]').length ? i() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="netflix"]').length ? r() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    1 == e && 0 == $('[data-action="kr"]').length ? l() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            })
        }
