;(function($, Lampa) {
	...
	var head = Lampa.Template[use_js ? 'js' : 'get']('head_backward',{title: title});
	if(use_js){
	...
	Modal.prototype.open = function(){
	    ...
	    if(Lampa.Platform.screen('mobile') && this.active.size !== 'full'){
		...
		this.html.find('.modal__content').prepend(close_button);
	    }
	    ...
	    if(this.active.size === 'full' && Lampa.Platform.screen('mobile')){
		this.scroll.append(HeadBackward(this.active.title || ''));
	    }
